...
public interface ProfileBusinessFunctionPermissionRepository extends JpaRepository<ProfileBusinessFunctionPermission, Integer> {
    ...
    List<ProfileBusinessFunctionPermission> findProfileBusinessFunctionPermissionByBusinessFunctionPermissionId(Integer id);
    ...
    @Modifying
    @Query("DELETE FROM ProfileBusinessFunctionPermission pbfp WHERE pbfp.profile.id = ?1")
